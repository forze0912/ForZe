...
var dt = (e, r, t) => r in e ? Ct(e, r, {
  ...
  value: t
    ...
    Ce = (e, r) => {
  for (var t in r || (r = {})) Qr.call(r, t) && dt(e, t, r[t]);
...
function Yt(e, r) {
  ...
  function P(l = Ut, y = bt) {
    let g,
        v = nn.replace("{{user}}", l != null ? l : Ut),
        A = sn.replace("{{user}}", y != null ? y : bt),
...
`) throw new Error(g);
  ...
  function E(l = {}) {
    ...
    }], [0, 1, 3, 1, 2, 3], l.tex, l.prog, l.uniform), D();
  }
  ...
  function M(l, y = {}) {
    ...
    if (y.tiled) {
      ...
      for (let K = 0; K < k; K++) for (let oe = 0; oe < T; oe++) E(Re(Ce({}, y), {
    ...
    } else y.width && y.height ? (R.x = y.width / v, R.y = y.height / A) : y.width ? (R.x = y.width / v, R.y = R.x) : y.height && (R.y = y.height / A, R.x = R.y), E(Re(Ce({}, y), {
      scale: R.scale(y.scale || u(1)),
      tex: l,
      quad: g,
      width: v,
...
function Gt(e = {}) {
  ...
  function _(p) {
    let $ = s(ce => {
      let ie = ce / 1e3,
          N = ie - t.realTime;
      t.realTime = ie, t.skipTime || (t.dt = N, t.time += t.dt, t.fpsBuf.push(1 / t.dt), t.fpsTimer += t.dt, t.fpsTimer >= 1 && (t.fpsTimer = 0, t.fps = Math.round(t.fpsBuf.reduce((l, y) => l + y) / t.fpsBuf.length), t.fpsBuf = [])), t.skipTime = !1;
...
function lr(e, r, t = {}) {
  ...
  function me(D, E, M, J = !1) {
    ...
    return s(_, "loadRawShader"), x(new Promise((W, V) => {
      ...
      if (s(F, "resolveUrl"), J) Promise.all([F(E), F(M)]).then(([L, p]) => {
        W(_(D, L, p));
      }).catch(V);else try {
        W(_(D, E, M));
      } catch (L) {
  ...
  Er.exports = (e = {}) => {
    ...
    function L(n) {
      let i = new Map(),
        ...
        use(a) {
          ...
          let b = s(() => {
            if (!!a.require) {
              for (let U of a.require) if (!this.c(U)) throw new Error(`comp '${a.id}' requires comp '${U}'`);
            }
          }, "checkDeps");
    ...
    function ze(n, i, o) {
      let d = ce("collide", n, (h, b, U) => b.is(i) && o(h, b)),
          f = ce("collide", n, (h, b, U) => b.is(n) && o(b, h)),
          a = ie(n, h => {
    ...
    function R(n, i) {
      if (Array.isArray(n)) {
        let o = n.map(d => R(d, i));
        return () => o.forEach(d => d());
      } else return typeof n == "function" ? m.on("input", () => t.keyPressed() && n()) : m.on("input", () => t.keyPressed(n) && i());
    }
    ...
    function z(n, i) {
      if (Array.isArray(n)) {
        let o = n.map(d => z(d, i));
        return () => o.forEach(d => d());
      } else return typeof n == "function" ? m.on("input", () => t.keyPressed() && n()) : m.on("input", () => t.keyPressedRep(n) && i());
    }
    ...
    function k(n, i) {
      if (Array.isArray(n)) {
        let o = n.map(d => k(d, i));
        return () => o.forEach(d => d());
      } else return typeof n == "function" ? m.on("input", () => t.keyPressed() && n()) : m.on("input", () => t.keyReleased(n) && i());
    }
    ...
    function Ue() {
      R("f1", () => {
        ...
        ne.timeScale = fe(ne.timeScale - .2, 0, 2), C.info(`time scale: ${ne.timeScale.toFixed(1)}`);
      }), R("f9", () => {
        ne.timeScale = fe(ne.timeScale + .2, 0, 2), C.info(`time scale: ${ne.timeScale.toFixed(1)}`);
      }), R("f10", () => {
    ...
    function Ze(n) {
      ...
      d.shake = qe(d.shake, 0, 5 * X()), m.camMatrix = ue().translate(o.scale(.5)).scale(d.scale).rotateZ(d.angle).translate(o.scale(-.5)).translate(d.pos.scale(-1).add(o.scale(.5)).add(f)), xe(a => {
...
`));
    ...
    function Gr(n, ...i) {
      ...
      m.on("next", () => {
        m.events = {}, m.objEvents = {
          ...
          angle: 0,
          shake: 0
        }, m.camMousePos = t.mousePos(), m.camMatrix = ue(), m.layers = {}, m.defLayer = null, m.gravity = te, m.scenes[n](...i), e.debug !== !1 && Ue();
      });
    }
    ...
    return s(gn, "frames"), t.run(() => {
      if (Et++, c.frameStart(), m.loaded) m.camMousePos = m.camMatrix.invert().multVec2(t.mousePos()), m.trigger("input"), Ze(), ne.inspect && Ge(), ne.showLog && C.draw();else {
        let n = w.loadProgress();
        if (n === 1) m.loaded = !0, m.trigger("load");else {
          let i = x() / 2,
              o = 24 / c.scale(),
      ...
      c.frameEnd();
    }), e.debug !== !1 && Ue(), window.addEventListener("error", n => {
...
},{}]},{},["../../.nvm/versions/node/v16.8.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","node_modules/kaboom/dist/kaboom.mjs"], null)
//# sourceMappingURL=/kaboom.76251cc4.js.map