...
`));
  ...
  // patrol.js
  function patrol(speed = 60, dir2 = 1) {
    return {
      id: "patrol",
      require: ["pos", "area"],
      add() {
  ...
  loadRoot("http://192.168.1.5:5000 ");
  loadSprite("portal", "portal.png");
  loadSprite("bean", "bean.png");
  loadSprite("ghost", "googoly.png");
  ...
  scene("won", () => {
    ...
    keyPress("space", () => go("game")), mouseClick(() => go("game"));
  });
  scene("secret", () => {
    add([
